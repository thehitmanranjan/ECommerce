    ...
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-xl-4 offset-xl-4 col-md-6 offset-md-3">
                ...
                <div>
                    <h6 style='color:red;'><?php echo filter_input(INPUT_GET, 'success'); ?></h6>
                </div>
                <form action='settings_script.php' method='post'>
                    <div class="form-group">
                        <input class="form-control" type="password" placeholder="Old Password" name="oldpassword" required="required">
                        <div>
                            <p style='color:red;'><?php echo filter_input(INPUT_GET, 'olderror'); ?></p>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <p style='color:red;'><?php echo filter_input(INPUT_GET, 'confirmerror'); ?></p>
                        </div>
                    </div>
